...
import io.github.api.booking.fixture.CadastrarReservaRequestFixture;
import io.github.api.booking.fixture.PeriodoFixture;
...
//        RestAssured.replaceFiltersWith(new RequestLoggingFilter(), new ResponseLoggingFilter());
    ...
    void deveRetornarBadRequestAoTentarReservarImovelComPeriodoComDataFinalMenorQueDatainicial() {
        ...
        CreateBookingRequest requestComDataInvalida = CadastrarReservaRequestFixture
            .get()
            .valido()
    ...
    void deveRetornarBadRequestAoTentarReservarImovelComSolicitanteIgualAoAnunciante() {
        CreateBookingRequest reservaComSolicitanteEAnuncianteIguais = CadastrarReservaRequestFixture
                .get()
                .valido()
                .comIdAnunciante(1)
                .comIdSolicitante(1)
    ...
    void deveRetornarBadRequestAoTentarReservarImovelDoTipoHotelComMenosDeDuasPessoas() {
        CreateBookingRequest reservaHotelComUmaPessoa = CadastrarReservaRequestFixture
            .get()
            .valido()
    ...
    void deveRetornarBadRequestAoTentarReservarImovelDoTipoPousadaComMenosDeCincoDiarias() {
        Period periodDeTresDias = PeriodoFixture
            .get()
            .comDataHoraInicial(LocalDateTime.of(2022,1,1,14,0,0))
            .comDataHoraFinal(LocalDateTime.of(2022,1,4,12,0,0))
            .build();

        CreateBookingRequest reservaComTresDiarias = CadastrarReservaRequestFixture
            .get()
            .valido()
            .comIdAnunciante(ID_ANUNCIO_COM_POUSADA)
            .comPeriodo(periodDeTresDias)
            .build();
    ...
    void deveRetornarNotFoundAoTentarPagarReservaComIdQueNaoExiste() throws JsonProcessingException {
        ...
        given()
            .contentType(ContentType.JSON)
            .body(new ObjectMapper().writeValueAsString(PaymentTypes.SPECIE))
        .when()
    ...
    void deveRetornarBadRequestAoTentarPagarReservaComFormaPagamentoNaoAceita() throws JsonProcessingException {
        ...
        given()
            .contentType(ContentType.JSON)
            .body(new ObjectMapper().writeValueAsString(PaymentTypes.CREDIT_CARD))
        .when()
    ...
    void deveRetornarBadRequestAoTentarPagarReservaComStatusInvalido(Long idReserva) throws JsonProcessingException { //o campo status foi utilizado apenas para formatar o nome do método na apresentação do console
    ...
    void deveRetornarBadRequestAoTentarCancelarReservaComStatusInvalido(Long idReserva) { //o campo status foi utilizado apenas para formatar o nome do método na apresentação do console
        given()
        .when()
    ...
    void deveRetornarBadRequestAoTentarEstornarReservaComStatusInvalido(Long idReserva) { //o campo status foi utilizado apenas para formatar o nome do método na apresentação do console
        given()
        .when()
