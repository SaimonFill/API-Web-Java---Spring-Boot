...
import io.github.api.booking.fixture.CadastrarAnuncioRequestFixture;
...
//        RestAssured.replaceFiltersWith(new RequestLoggingFilter(), new ResponseLoggingFilter());
    ...
    void deveRetornarNotFoundAoTentarAnunciarComIdAnuncianteQueNaoExiste() {
        RegisterAnnouncementRequest requestComIdAnuncianteInexistente = CadastrarAnuncioRequestFixture
            .get()
            .valido()
    ...
    void deveRetornarNotFoundAoTentarAnunciarComIdImovelQueNaoExiste() {
        RegisterAnnouncementRequest anuncioRequestComIdImovelInexistente = CadastrarAnuncioRequestFixture
            .get()
            .valido()
            .comIdImovel(999L)
            .build();
    ...
    void deveRetornarBadRequestAoTentarAnunciarSemCamposObrigatorios() {
        RegisterAnnouncementRequest anuncioRequestSemCamposObrigatorios = CadastrarAnuncioRequestFixture
            .get()
            .build();
    ...
    void deveRetornarOKAoCriarOutroAnuncioParaImovelJaAnunciadoAnteriormentePoremCujoAnuncioFoiExcluido() {
        RegisterAnnouncementRequest anuncioRequestComMesmoIdImovelDeAnuncioExcluido = CadastrarAnuncioRequestFixture
                .get()
                .valido()
                .comIdImovel(12L)
                .build();
